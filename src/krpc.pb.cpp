...
const pb_field_t krpc_schema_ProcedureCall_fields[6] = {
    PB_FIELD(  1, STRING  , SINGULAR, STATIC  , FIRST, krpc_schema_ProcedureCall, service, service, 0),
    PB_FIELD(  2, STRING  , SINGULAR, STATIC  , OTHER, krpc_schema_ProcedureCall, procedure, service, 0),
